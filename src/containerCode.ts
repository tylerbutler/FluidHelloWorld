...
import { CounterPlusInstantiationFactory } from "./dataObject";
 ...
 */
export const CounterPlusContainerRuntimeFactory = new ContainerRuntimeFactoryWithDefaultDataStore(
    CounterPlusInstantiationFactory.type,
    new Map([
        CounterPlusInstantiationFactory.registryEntry,
    ]),
);
